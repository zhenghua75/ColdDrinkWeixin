...
using ColdDrinkWeixin.CommonService.Download;
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            if (requestMessage.EventKey.StartsWith("qrscene_"))
            {
                ...
                if (codeRecord != null)
                {
                    ...
                    {
                        Task.Factory.StartNew(() => CustomApi.SendTextAsync(null, WeixinOpenId, "下载已经开始，如需下载其他版本，请刷新页面后重新扫一扫。"));
                    }
                    else
                    {
                        //确认可以下载
                        codeRecord.AllowDownload = true;
                        Task.Factory.StartNew(() => CustomApi.SendTextAsync(null, WeixinOpenId, GetDownloadInfo(codeRecord)));
                    }
                }
            }
