...
using ColdDrinkWeixin.CommonService.TemplateMessage;
using ColdDrinkWeixin.CommonService.Utilities;
using Senparc.Weixin.MP;
using Senparc.Weixin;

namespace ColdDrinkWeixin.CommonService
{
    /// <summary>
    /// 全局微信事件有关的处理程序
    /// </summary>
        ...
        public void ConfigOnWeixinExceptionFunc(WeixinException ex)
        {
            try
            {
                Task.Factory.StartNew(async () =>
                {
                    ...
                    string url = "https://github.com/JeffreySu/WeiXinMPSDK/blob/24aca11630bf833f6a4b6d36dce80c5b171281d3/src/ColdDrinkWeixin/ColdDrinkWeixin/Global.asax.cs#L246";//需要点击打开的URL
